...
export const meta: MetaFunction = () => ({
  ...
  description:
    "I'm a 16 year old mostly self-taught full-stack developer from Switzerland. I'm currently working on a few projects and I'm always looking for new opportunities.",
})
      ...
      <Contact>
        ...
        >
          <Input
            ...
            placeholder='Sami Hindi'
            required
          />
          <Input
            name='email'
            label='Where can I reach you?'
            placeholder='sami@samihindi.com'
            required
          />
          ...
          <Textarea
            ...
            placeholder="Hi Sami, let's work!"
            required
          />
          <SubmitButton>
